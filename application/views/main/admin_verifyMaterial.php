...
<aside>
    <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub"> 
                <a class="active" href="<?php echo base_url()?>admin/material/verify">
...
<section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-book"></i> VERIFY MATERIALS</h3>
        <div class="row mt">
          <div class="col-md-12">
 ...
 $(document).ready(function(){
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'Admin_controller/fetch_division_publish_material'; ?>",  
                type:"POST"  
           },  
           "columns": [
            { "width": "15%" }, //Title
      ...
      $(document).on('click', '.publish', function(){  
           var user_id = $(this).attr("id");  
            $.ajax({  
                url:"<?php echo base_url(); ?>Admin_controller/publish_material",  
                method:"POST",  
                data:{user_id:user_id},   
                success:function(data)  
                {  
