                ...
                <form method="post" id="user_form">  
                    <div class="form-panel">  
                        ...
                        <div class="modal-body">  
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="email" placeholder="Email" name="user_email" id="user_email" class="form-control" required="">
                                </div>
                            </div>
                            <br/><br/> 
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="text" placeholder="Username" name="user_username" id="user_username" class="form-control">
                                </div>
                            </div>
                            <br/><br/> 
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="password" placeholder="Password" name="user_password" id="user_password" class="form-control" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" minlength="8" maxlength="8" title="Must contain number and letter, and at least 8 characters">
                                </div>
                            </div>
                            <br/><br/> 
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="password" placeholder="Confirm Password" name="user_confirmPassword" id="user_confirmPassword" class="form-control" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" minlength="8" maxlength="8" title="Must contain number and letter, and at least 8 characters">
                                </div>
                            </div>
                            <br/><br/> 
                            <div class="form-group">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                       <!--  <span class="help-block" style="color: red; font-size: 10px;margin: 0">*Required</span> -->
