...
<aside>
    <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub"> 
                <a class="active" href="<?php echo base_url()?>admin/material/add">
            ...
            <div class="form-panel">
              ...
              <form method="post" id="material_form" class="form-horizontal style-form">
                    ...
                    <div class="form-group ">
                      <label class="col-lg-2 control-label"><b><span style="color: red">* </span>Title</b></label>
                      <div class="col-lg-10">
                        
                        <input type="text" name="material_title" id="material_title" class="form-control" placeholder="" >
                      </div>
                    </div>

                    <div class="form-group ">
                      <label class="col-lg-2 control-label"><b><span style="color: red">* </span>Description</b></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group">
                      <label class="col-lg-2 control-label"><b><span style="color: red">* </span>Category</b></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      <label class="col-lg-2 control-label"><b><span style="color: red">* </span>Source</b></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      <label class="col-lg-2 control-label"><b><span style="color: red">* </span>File</b></label>
                      <div class="col-lg-10">
...
<script type="text/javascript" language="javascript" >  
    $(document).ready(function(){
        ...
        $(document).on('submit', '#material_form', function(event){  
            ...
            if(extension != ''){  
                if(jQuery.inArray(extension, ['gif','jpg','jpeg','png','iso','dmg','zip','rar','doc','docx','xls','xlsx','ppt','pptx','csv','ods','odt','odp','pdf','rtf','sxc','sxi','txt','exe','avi','mpeg','mp3','mp4','3gp', 'mkv', 'pub']) == -1){  
                    alert("Invalid File");  
                    $('#material_file').val('');  
                    return false;  
                }  
            ...
            if (material_title == "" || material_description == "" || material_category == "" || material_source == "" || material_file == "") {
                Swal.fire(
                    'Error!',
                    ...
                    success:function(data){  
                        ...
                        Swal.fire({
                          ...
                          if (result.value) {
                            ...
                            document.location = "<?php echo base_url()?>admin/material/publish";
                          }
                        })
